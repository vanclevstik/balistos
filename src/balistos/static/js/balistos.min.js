...
$(".user").click(function(e){e.stopPropagation();$("#logout").slideDown();});$(".open-login").click(function(e){e.stopPropagation();$(".menu-button").removeClass("active");$(".open-login").addClass("active");$(".dropdown").hide();$("#login").slideDown();});$(".open-register").click(function(e){e.stopPropagation();$(".menu-button").removeClass("active");$(".open-register").addClass("active");$(".dropdown").hide();$("#register").slideDown();});$(".open-create").click(function(e){e.stopPropagation();$(".menu-button").removeClass("active");$(".open-register").addClass("active");$(".dropdown").hide();$("#create").slideDown();});$(".dropdown").click(function(e){e.stopPropagation();});$(document).click(function(){$(".menu-button").removeClass("active");$(".dropdown").hide();});}(jQuery));